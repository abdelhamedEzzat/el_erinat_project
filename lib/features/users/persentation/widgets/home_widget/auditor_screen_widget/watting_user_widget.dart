...
class WattingUserWidget extends StatefulWidget {
  const WattingUserWidget({super.key});

  @override
  State<WattingUserWidget> createState() => _WattingUserWidgetState();
}

class _WattingUserWidgetState extends State<WattingUserWidget> {
  final List<String> items = ['مستخدم', 'مشرف', 'مسؤول'];
