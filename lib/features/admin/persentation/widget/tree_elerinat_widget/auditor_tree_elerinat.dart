      ...
      BlocConsumer<TreeElerinatCubit, TreeElerinatState>(
        listener: (context, state) async {
          if (state is UploadTreeSuccess) {
            BlocProvider.of<TreeElerinatCubit>(context).addNewsItem(
                state.tree, FirebaseAuth.instance.currentUser!.uid);
          }
        },
        builder: (context, state) {
          if (state is GetAuditorTreeLoading) {
            ...
            return state.id == FirebaseAuth.instance.currentUser!.uid
                ? Column(children: [
                    Align(
                          ...
                          onTap: () async {
                            ...
                            if (update == "Success update tree") {
                              if (mounted) {
                                ...
                                await BlocProvider.of<TreeElerinatCubit>(
                                        context)
